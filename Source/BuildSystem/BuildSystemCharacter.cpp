...
ABuildSystemCharacter::ABuildSystemCharacter()
{
	...
	BuildComponent = CreateDefaultSubobject<UBuildableManagerComponent>(TEXT("BuildComponent"));
	BuildComponent->InitializeBuildableManagerComponent(FollowCamera);
...
void ABuildSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ABuildSystemCharacter::Look);
...
void ABuildSystemCharacter::DoMove(float Right, float Forward)
{
...
void ABuildSystemCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ABuildSystemCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ABuildSystemCharacter::DoJumpEnd()
{
